# Generated by Django 3.1.1 on 2020-09-01 15:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_url', models.URLField(blank=True, default='https://www.cowgirlcontractcleaning.com/wp-content/uploads/sites/360/2018/05/placeholder-img.jpg', null=True)),
                ('price', models.DecimalField(decimal_places=2, default=0.0, max_digits=10)),
                ('category', models.CharField(blank=True, choices=[('', ''), ('Animals', 'Animals'), ('Electronics', 'Electronics'), ('Fashion', 'Fashion'), ('Housing', 'Housing'), ('Media', 'Media'), ('Services', 'Services')], max_length=64, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('bidValue', models.DecimalField(decimal_places=2, default=0.0, max_digits=10)),
